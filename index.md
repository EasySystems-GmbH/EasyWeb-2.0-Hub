...
Welcome to the public EasyWeb 2.0 documentation hub.

## What's in EasyWeb 2.0
...
- **CLI & VS Code** — `easyweb publish`, `push-navigation`, `pull` / `sync`, validate, and remote editing (`easyweb help` prints the hub docs URL)
- **Docker** — run locally or on ESYS Hosting with PostgreSQL

## Quick Links

- [Getting Started](docs/getting-started.md)
- [Install with Docker](docs/install-with-docker.md)
- [CMS admin](docs/cms-admin.md) — pages, WYSIWYG, sliders, gallery
- [CMS permissions](docs/cms-permissions.md)
- [Themes and content](docs/themes-and-content.md) — Liquid, pages, sliders
- [CLI](docs/cli.md) — publish, pull, sync
